...
void firstPage()
{
    ...
    cout << "____________________________WELCOME TO PAKISTAN RAILWAYS______________________________" << endl
        << endl;
...
public:
    ...
    void trains()
    {
        string trainsN[] = { "LAHORE", "KARACHI", "ISLAMABAD", "SARGODHA", "FAISALABAD", "MULTAN" };
        ...
        cout << "\nWELCOME TO THE PAKISTAN RAIWAYS!" << endl;
        ...
        case 1:
        {
            ...
            if (choice1 == 1)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN LHR-123" << endl;
            ...
            else if (choice1 == 2)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN LHR-345" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else if (choice1 == 3)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN LHR-456" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else
            {
        ...
        case 2:
        {
            ...
            if (choice1 == 1)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN KHI-897" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else if (choice1 == 2)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN KHI-567" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else if (choice1 == 3)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN KHI-789" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else
            {
        ...
        case 4:
        {
            ...
            if (choice1 == 1)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN SGD-123" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else if (choice1 == 2)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN SGD-345" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else if (choice1 == 3)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN SGD-456" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else
            {
        ...
        case 5:
        {
            ...
            if (choice1 == 1)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN FSD-123" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else if (choice1 == 2)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN FSD-345" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else if (choice1 == 3)
            {
                ...
                cout << "\n YOU HAVE SUCCESFULLY BOOKED THE TRAIN FSD-456" << endl;
                cout << " YOU CAN GO BACK TO MENU AND TAKE THE TICKET " << endl;
            }
            else
            {
...
public:
    ...
    void displayMenu()
    {
        ...
        cout << "\t|6."
            ...
            << "\t\t|" << endl;
        cout << "\t|7."
            << "\t|Simple Pakistani Thali"
            << "\t\t|Rs. 210"
            << "\t\t|" << endl;
        cout << "\t|8."
            << "\t|Special Pakistani Thali"
            << "\t\t|Rs. 240"
            << "\t\t|" << endl;
        ...
        tryagain:
            ...
            case 7:
            {
                cout << "Simple Pakistani Thali booked!" << endl;
                fcharges += 210;
                f2 << "\t|Simple Pakistani Thali"
                    << "\t"
                    << "Rs. 210" << endl;
                f3 << cpnr << " Simple Pakistani Thali"
                    << " 210" << endl;
                break;
            }
            ...
            case 8:
            {
                cout << "Special Pakistani Thali booked!" << endl;
                fcharges += 240;
                f2 << "\t|Special Pakistani Thali"
                    << "\t"
                    << "Rs. 240" << endl;
                f3 << cpnr << " Special Pakistani Thali"
                    << " 240" << endl;
                break;
            }
